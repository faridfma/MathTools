...
class MultiplicationMathGUI:
    def __init__(self, root):
        ...
        self.instruction_label = tk.Label(self.root, text="Click 'Generate' and save Addition problems.", font=("Arial", 14))
    ...
    def generate_and_save_problems(self):
        ...
        for _ in range(16):  # 16 lines of 3 problems each
            ...
            multiplicand1 = random.randint(10, 99)
            multiplier1 = random.randint(1, 9)
            product1 = multiplicand1 + multiplier1
            
            multiplicand2 = random.randint(10, 99)
            multiplier2 = random.randint(1, 9)
            product2 = multiplicand2 + multiplier2
            
            multiplicand3 = random.randint(10, 99)
            multiplier3 = random.randint(1, 9)
            ...
            multiplier_line = f" + {multiplier1}".rjust(13) + f" + {multiplier2}".rjust(31) + f" + {multiplier3}".rjust(29)
